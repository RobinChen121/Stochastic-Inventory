 ...
 * @description: One level sS fitting for capacitated lot sizing problem
 * 
 */
public class OneLevelFitsSTest {
	...
	public static void main(String[] args) {
		...
		double[] K = { 200, 500, 800 }; 
		double[] v = { 2, 5, 10 };
		double[] pai = { 15, 10, 5};
		double[] capacity = { 1, 2, 3 };
				...
				for (int ipai = 0; ipai < pai.length; ipai++) {
					for (int idemand = 0; idemand < demands.length; idemand++)
						for (int icapacity = 0; icapacity < capacity.length; icapacity++) {
							...
							double simFinalValue = simuation.simulateSinglesS(initialState, optsS, maxOrderQuantity);
