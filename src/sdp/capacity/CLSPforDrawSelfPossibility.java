...
import sdp.capacity.CLSP.State;
import umontreal.ssj.probdist.PoissonDist;

public class CLSPforDrawSelfPossibility {
	...
	public CLSPforDrawSelfPossibility(double fixedOrderingCost, double proportionalOrderingCost, double penaltyCost, 
	...
	public static void main(String[] args) {		  
	      ...
	      CLSPforDrawSelfPossibility inventory = new CLSPforDrawSelfPossibility(fixedOrderingCost, proportionalOrderingCost, penaltyCost, 
	      ...
	      CLSPforDrawSelfPossibility inventory2 = new CLSPforDrawSelfPossibility(fixedOrderingCost, proportionalOrderingCost, penaltyCost, 
		  			holdingCost, stepSize, minState, maxState, truncationQuantile,
		  			meanDemand, maxOrderQuantity);
